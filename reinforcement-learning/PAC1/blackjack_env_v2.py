...
def is_natural(hand, first_hand): 
    """
    Funció que espera com a paràmetre un array d'enters. 
    Retorna true si la suma de la mà és 21 i és la primera mà.
    """
#    print("Suma de la mà: {}".format(sum_hand(hand)))   
#    print("Return is_natural: {}".format(first_hand and sum_hand(hand) == 21))
    return first_hand and sum_hand(hand) == 21
...
class BlackjackEnv(gym.Env):
    ...
    def _step(self, action):
        ...
        if not is_natural(self.player, self.first_hand):
            ...
            reward = cmp(score(self.player), score(self.dealer)) * 1.5        
#        if (done):
#            print("Fí de la partida amb un reward de: {}".format(reward))      
#            print("El valor del dealer: {} amb la mà: {}".format(score(self.dealer), self.dealer ))                  
#            print("El valor del player: {} amb la mà: {}".format(score(self.player), self.player))
